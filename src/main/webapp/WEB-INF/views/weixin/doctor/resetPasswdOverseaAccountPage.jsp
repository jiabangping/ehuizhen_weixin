...
<!-- 正在加载中 -->
                                         ...
                                         <div class="myForms2">
                                         	<span style="display: inline-block;width: 100%;text-align: center;margin: 0px auto ;margin-bottom: 16px;font-size:20px;">重置密码</span>
                                         	<span style="display: inline-block;width: 100%;text-align: center;margin: 0px auto;margin-bottom: 10px;font-size:15px;"><span style="font-size:16px; color:blue;" >${doctorName}</span>您好，请继续完成密码重置</span>
                                         	
                                         	<span id="warn" style="display: inline-block;width: 100%;text-align: center;margin: 0px auto;margin-bottom: 10px;font-size:15px;color:red;"></span>
                                            <input id="myPass" type="password" class="myPass2" placeholder="请输入6-15位密码">
                                             ...
                                             <button id="resetPasswdBtn" type="button" class="btn2 btn-green2 btn-big2 btn-block2 login-btn2" style="background:#00abec;border-radius:5px;">重置</button>
                                         </div>
                                    </div>
                                </div>
                        </div>
