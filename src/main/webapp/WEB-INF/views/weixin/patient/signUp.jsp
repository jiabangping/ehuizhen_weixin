   ...
   <div id="maskAlert" class="container">
    ...
    <div class="row headTitle">
    	...
    	<!--  <a href="patient/signInPage" class="right">登录</a> -->
    	 <a href="patient/wxBindPage" class="right" style="color:#00abec">绑定</a>
    	 </div>
    </div>
	<span id="warn"></span>
		...
		<div id="" class="row" style="margin-bottom:15px;">
       		...
       		<div>
            	<div class="col-xs-8" style="padding-right:10px;">
               		<input placeholder="请输入6位验证码" type="number" class="form-control {required:true,verifyCode:true}" id="verifyCode" name="verifyCode">
            	</div>
 		...
 		<div class="form-group ">
          <label class="control-label" style="padding-top:0;padding-bottom:3px;" for="inputError1">密码</label>	
           <input type="password" placeholder="请输入6-15位密码"  class="form-control {required:true,passwd:true}" id="passWord" name="passWord">
        </div>
        
        <div>
        	<p>点击注册默认接受<a id="protocol" style="text-decoration: none;">《e会诊患者使用协议》</a></p>
        	</div>
...
$("#protocol").click(function() {
	window.open("patient/registeProtocolPage","_self");//,"_self"
	return false;
})
</script>
</body>
