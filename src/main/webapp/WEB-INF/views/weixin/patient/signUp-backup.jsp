   ...
   <div id="maskAlert" class="container">
    ...
    <form class="form-horizontal">
        <div class="form-group wrap">
            <div class="col-xs-3 control-label rowLeft" >
		...
		<div class="col-xs-9 right" >	
		  ...
		  <input type="tel" placeholder="请输入年龄"  class="form-control" id="age2" name="age2" style="display:inline-block;width:82px;">岁
			<!-- <div class="btn-group" style="">
			   <button id="ageBtn" type="button" class="btn btn-primary dropdown-toggle" 
			      data-toggle="dropdown" style="color: white;background: #00abec;border: none;width:85px;height:32px;">
			...
			<span id="year" style="margin-left:5px;"></span>
			
			
			<!-- <div class="btn-group" style="">
			   <button id="ageBtn" type="button" class="btn btn-primary dropdown-toggle" 
			      data-toggle="dropdown" style="color: white;background: #00abec;border: none;width:45px;height:32px;">
			    
			      <span id="ageDesc">月</span> <span class="caret"></span>
			   </button>
			   <ul class="dropdown-menu" role="menu" id="ageUl" style="height:250px;overflow:scroll;">
			   ...
			   <li><a id="1" style="margin-left:6px;">1<span style='margin-left:5px;'>岁<span></span></a></li> <li class='divider'></li>
				...
				<span style="margin-left:15px"><span id="realAge">20<span>岁</span>
       		</div> -->
        </div>   
        ...
        <div class="form-group wrap">
            ...
            <div class="col-xs-5 right" style="padding-right:4px;">
                <input type="tel" placeholder="请输入验证码"  class="form-control" id="verifyCode" name="verifyCode">
            </div>
            <div class="col-xs-4 verifyCodeBtn" >
                <a id="getVerifyCode" class="form-control btn-primary" style="background:#00abec;border:none;outline:none;padding-top:8px;cursor:pointer;text-shadow:none">获取验证码</a>
            </div> 
        </div>
        ...
        <button id="signUpBtn" type="button" class="btn btn-primary btn-lg btn-block" style="border:none;outline:none;margin-bottom:10px;" >注册</button>
    </form>
</div>
<script>
$(function() {
