 ...
 *
 */
public class AjaxUploadFileServlet_back extends HttpServlet {
	...
	/** 日志对象*/
	private Logger logger = LoggerFactory.getLogger(AjaxUploadFileServlet_back.class);
	...
	String path = request.getContextPath();
		String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
				+ path + "/";
	String urlPath = basePath + "/" + uploadFolderName+"/";
		try {
			//清除上次上传进度信息
...
//			responseMessage(response, State.OK);
			responseMessage(response, State.OK,urlPath);
