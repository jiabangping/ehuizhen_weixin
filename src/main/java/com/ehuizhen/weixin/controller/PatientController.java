...
public class PatientController {
	...
	/**患者我的会诊列表 */
	@RequestMapping(value = "patient/registeProtocolPage", method = RequestMethod.GET)
	public ModelAndView registeProtocolPage(HttpServletRequest request,HttpServletResponse response,HttpSession session
			) throws Exception {
		ModelAndView model = new ModelAndView("/weixin/patient/registeProtocol");
		return model;
	}
