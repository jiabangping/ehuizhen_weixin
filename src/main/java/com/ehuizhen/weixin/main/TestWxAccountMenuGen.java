...
public class TestWxAccountMenuGen {
	private static Logger log = LoggerFactory.getLogger(TestWxAccountMenuGen.class);
	...
	//static String baseUrl = "http://testweixin.zhongyinginfo.com/ehuizhen_weixin/";
