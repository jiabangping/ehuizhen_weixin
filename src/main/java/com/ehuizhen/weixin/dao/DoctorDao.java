...
public class DoctorDao {
	...
	@SuppressWarnings("unchecked")
	public List<DoctorModel> getDoctors() throws Exception {
		List<DoctorModel> doctors = (List<DoctorModel>) hibernateTemplate.find("from DoctorModel where 1=1 and status = '1' ");
		return doctors;
	}
