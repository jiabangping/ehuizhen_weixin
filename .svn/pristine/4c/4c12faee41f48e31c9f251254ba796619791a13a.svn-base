package com.ehuizhen.weixin.wxpay;
...
import com.ehuizhen.weixin.wxpay.util.MD5Util;
import com.ehuizhen.weixin.wxpay.util.TenpayUtil;
...
public class ResponseHandler { 
	...
	public ResponseHandler(HttpServletRequest request,
		...
		Map<Object, Object> m = this.request.getParameterMap();
	...
	*/
	 ...
	 * @return SortedMap
	 */
	public SortedMap<Object, Object> getAllParameters() {
	...
	public void setUriEncoding(String uriEncoding)
		...
		if (!"".equals(uriEncoding.trim())) {
			...
			Iterator<Object> it = this.parameters.keySet().iterator();
			while (it.hasNext()) {
				String k = (String) it.next();
