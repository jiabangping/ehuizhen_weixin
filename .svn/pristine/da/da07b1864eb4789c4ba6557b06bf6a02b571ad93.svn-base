...
<!-- 正在加载中 -->
                                         ...
                                         <div class="myForms2">
                                         	<span style="display: inline-block;width: 50%;text-align: center;margin: 0px auto ;margin-left: 57px;margin-bottom: 10px;font-size:17px;">重置密码</span>
                                            ...
                                            <input id="myPass" type="password" class="myPass2" placeholder="请输入6-15位密码">
                                             ...
                                             <button id="resetPasswdBtn" type="button" class="btn2 btn-green2 btn-big2 btn-block2 login-btn2" style="margin-left:-26px;background:#00abec;border-radius:5px;">重置</button>
                                         </div>
                                    </div>
                                </div>
                        </div>
