   ...
   <div id="maskAlert" class="container">
    ...
    <form class="form-horizontal" id="myForm">
        ...
        <div class="form-group " id="phoneNumGroup">
          <label class="control-label" for="inputError1" style="padding-top:0;padding-bottom:3px;">手机号码</label>
		...
		<div class="form-group ">
          <label class="control-label" for="inputError1" style="padding-top:0;padding-bottom:3px;">新密码</label>
     ...
     <!--    <div>
        ...
        <button id="signUpBtn" type="button" class="btn btn-primary btn-lg btn-block" style="border:none;outline:none;margin-top:10px;margin-bottom:20px;" >重置</button>
    </form>
</div>
<input type="hidden" id="token" value="${token}">

<script src="static/js/patient/resetPasswd.js"></script>
<script>
